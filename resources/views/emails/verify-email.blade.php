  ...
  <div role="article" aria-roledescription="email" aria-label="Confirm your email address" lang="en">
        ...
        <tr>
          <td style="width: 552px; max-width: 100%">
            <div class="sm-my-8" style="margin-top: 48px; margin-bottom: 48px; text-align: center">
              <a href="/">
                <img src="{{asset('images/emails/jobdeck-logo.png')}}" width="112" alt="Jobdeck" style="max-width: 100%; vertical-align: middle">
              </a>
            </div>
            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td class="sm-px-6" style="border-radius: 4px; background-color: #fffffe; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                  <h1 class="sm-leading-8" style="margin: 0 0 24px; font-size: 18px; font-weight: 600; color: #000001">
                    Hi {{$user->name}},
                  </h1>
                  <p style="margin: 0; line-height: 24px">
                    Please verify that this is your email address, and that you
                    entered it when signing up for Jobdeck.
                  </p>
                  <div role="separator" style="line-height: 24px">&zwj;</div>
                  <div>
                    <a href="{{$url}}" style="color: #f8fafc; display: inline-block; border-radius: 4px; background-color: #14b8a6; padding: 16px 24px; font-size: 16px; line-height: 1; font-weight: 600; text-decoration: none">
                      <!--[if mso]>
    ...
    <![endif]-->
                  ...
                  <p style="margin: 0; font-size: 14px; line-height: 24px; color: #64748b">
                    If the button isn't clickable, you can copy and paste this URL
                    into your browser.
                    <br>
                    {{$url}}
                    <br>
                  ...
                  <p style="line-height: 24px;">Welcome aboard! <br>The Jobdeck Team</p>
                </td>
              </tr>
              <tr role="separator">
              ...
              <tr>
                <td style="padding-left: 24px; padding-right: 24px; text-align: center; font-size: 12px; color: #64748b">
                  <p style="margin: 0; font-style: italic">
                    If you did not enter this email address when signing up for
                    Jobdeck, disregard this message.
                  </p>
                </td>
              </tr>
              <tr role="separator">
              ...
              <tr>
                <td style="padding-left: 24px; padding-right: 24px; padding-bottom: 24px; text-align: center; font-size: 12px; color: #475569">
                  <p style="margin: 0;">©Jobdeck - All Right Reserved.</p>
                </td>
              </tr>
            </table>
          </td>
