        ...
        <form class="w-full space-y-6" @submit.prevent="submit">
          <div class="w-full">
            <BaseLabel :is-required="true" label="Degree Name">
              <XInput
                ...
                placeholder="Bachelor of Arts (B.A.), English Literature"
              />
          ...
          <div class="w-full">
            <BaseLabel :is-required="true" label="Years Attended">
              <XInput
                class="w-full"
                v-model="educationForm.years_attended"
                placeholder="09/2014 - 06/2018"
              />
              <p class="form-error">
                {{ educationForm.errors.years_attended }}
              </p>
            </BaseLabel>
          </div>
          ...
          <div class="w-full">
            <BaseLabel label="Academic Progress">
              <p class="mb-4 text-sm text-gray-600 dark:text-gray-400">
                Write about the state of your study, if you completed it or when
                you expect to graduate. Additionally you could include your GPA
              ...
              />
              <p class="form-error">
                {{ educationForm.errors.academic_progress }}
              </p>
            </BaseLabel>
          </div>
          ...
          <div>
            <BaseLabel label="Additional Information">
              <p class="text-sm text-gray-600 dark:text-gray-400">
                Write any extra information about your education, such as
                relevant coursework, honors and awards, thesis or dissertation.
              </p>
              ...
              />
              <p class="form-error">
                {{ educationForm.errors.additional_information }}
              </p>
            </BaseLabel>
          </div>
        </form>
...
const submit = () => {
  if (props.modalType == "New") {
    ...
    educationForm.patch(
      route("education.update", props.education.id),
      formOptions,
    );
  }
};
...
onUpdated(() => {
  if (props.education) {
    ...
    educationForm.additional_information =
      props.education.additional_information;
  }
});
</script>
