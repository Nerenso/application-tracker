  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        <section
          ref="contentRef"
          class="bottom-0 mx-auto flex h-[95dvh] origin-top flex-col overflow-hidden rounded-tl-lg rounded-tr-lg bg-white shadow-[rgba(0,0,0,0.2)0px_-6px_12px_0px] sm:m-auto sm:h-fit sm:max-h-[90vh] sm:max-w-sm sm:rounded-lg sm:shadow-none"
        >
          <!-- <header
