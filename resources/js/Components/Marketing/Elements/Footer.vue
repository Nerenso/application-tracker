    ...
    <div class="mx-auto max-w-6xl">
      <div class="grid grid-cols-1 items-center justify-center lg:grid-cols-4">
        <div class="col-span-1 mx-auto mb-12 mt-10 lg:mx-0">
          <a href="/">
            <AppLogo mode="dark" class="w-[130px]" />
          </a>
        </div>
        ...
        >
          ...
          >
            <a
              href="#"
              class="block text-slate-400 transition-all duration-500 hover:text-teal-600"
            >
              <svg
                class="h-[1.688rem] w-[1.688rem]"
      ...
      <p class="text-center text-sm font-medium text-gray-600">
        ...
        <a
          ...
          class="transition-all duration-200 hover:text-orange-500"
          >Rebelfox</a
        >. All Rights Reserved.
      </p>
    </div>
